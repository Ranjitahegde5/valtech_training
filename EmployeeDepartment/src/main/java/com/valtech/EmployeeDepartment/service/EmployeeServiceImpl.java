...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public void populateEmployee() {
		...
		Employee emp = new Employee("Ranjita",21,1,1,45000);
		Employee emp1 = new Employee("Shraddha",20,1,1,45000);
		Employee emp2 = new Employee("Krupa",22,1,1,45000);
		Employee emp3 = new Employee("Khyati",20,1,1,45000);
		Employee emp4 = new Employee("Lavanya",22,1,1,45000);
		
		Department dep = new Department("HR","Sirsi");
